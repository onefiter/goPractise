...
import (
	...
	testdata "github.com/goPractise/hade/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/goPractise/hade/framework/gin.handlerNameTest$", c.HandlerName())
}
